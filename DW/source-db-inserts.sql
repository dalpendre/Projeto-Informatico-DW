...
INSERT INTO t_time (event_key, c_day, c_month, c_year, c_weekend_day, c_week_day_number, c_week_day_name, c_is_holiday, c_trimester, c_semester, c_season, c_full_date_description)
...
INSERT INTO t_cam (time_key, segment_key, station_id, latitude, longitude, altitude, speed, heading, acceleration, station_type, vehicle_role, time_stamp, fuel_type, activation_data, stationary_since)
VALUES
    (31, 71, 1001, 123456, 789012, 100, 60, 90, 5, 1, 1, 1621456789, '0100', '0000', 0),
    (32, 72, 1002, 234567, 890123, 200, 55, 120, 3, 2, 2, 1621456790, '0101', '0001', NULL),
    (33, 73, 1003, 345678, 901234, 150, 70, 180, 2, 1, 1, 1621456791, '0100', '0101', NULL),
    (34, 74, 1004, 456789, 012345, 180, 65, 270, 4, 2, 2, 1621456792, '0101', '0011', NULL),
    (35, 75, 1005, 567890, 123456, 120, 50, 45, 1, 1, 1, 1621456793, '0100', '0001', NULL),
    (36, 76, 1006, 678901, 234567, 220, 75, 150, 3, 2, 2, 1621456794, '0101', '0110', NULL),
    (37, 77, 1007, 789012, 345678, 170, 80, 225, 2, 1, 1, 1621456795, '0100', '0011', NULL),
    (38, 78, 1008, 890123, 456789, 200, 70, 315, 4, 2, 2, 1621456796, '0101', '0100', NULL),
    (39, 79, 1009, 901234, 567890, 140, 45, 90, 1, 1, 1, 1621456797, '0100', '0000', 1),
    (40, 80, 1010, 012345, 678901, 240, 80, 180, 3, 2, 2, 1621456798, '0101', '0010', NULL);
...
INSERT INTO t_ivim (zone_key, latitude, longitude, altitude)
VALUES
    (51, 123456, 789012, 100),
    (52, 234567, 890123, 200),
    (53, 345678, 901234, 150),
    (54, 456789, 012345, 180),
    (55, 567890, 123456, 120),
    (56, 678901, 234567, 220),
    (57, 789012, 345678, 170),
    (58, 890123, 456789, 200),
    (59, 901234, 567890, 140),
    (60, 012345, 678901, 240);