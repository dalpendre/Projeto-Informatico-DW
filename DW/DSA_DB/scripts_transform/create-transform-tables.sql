-- Database: projeto-informatico_dsa_db
...
(
	...
	start_point FLOAT NOT NULL,
	end_point FLOAT NOT NULL,
	FOREIGN KEY (road_key) REFERENCES t_data_road (road_key)
);
...
(
	...
	FOREIGN KEY (event_key) REFERENCES t_data_event (event_key)
);
...
(
	...
	FOREIGN KEY (time_key) REFERENCES t_data_time (time_key),
	FOREIGN KEY (segment_key) REFERENCES t_data_segment (segment_key)
); 
...
(
	...
	FOREIGN KEY (time_key) REFERENCES t_data_time (time_key),
	FOREIGN KEY (road_event_key) REFERENCES t_data_road_event (road_event_key)
);
...
(
	...
	longitude INT NOT NULL,
	altitude INT NOT NULL,
	FOREIGN KEY (road_sign_key) REFERENCES t_data_road_sign (road_sign_key),
	FOREIGN KEY (zone_key) REFERENCES t_data_zone (zone_key)
);
