...
def table_extract(table_name, key_name):
    ...
    try:
        ...
        if num_rows == 0:
            existing_rows = 0
            if os.path.exists("num_lines_in_extract_" + table_name + ".txt"):
                with open("num_lines_in_extract_" + table_name + ".txt", "w") as file:
                    file.write(f"Number of rows in table {table_name}: {existing_rows}")
        elif os.path.exists("num_lines_in_extract_" + table_name + ".txt"):
            with open("num_lines_in_extract_" + table_name + ".txt", "r") as file:
        ...
        print(colors.bcolors.OKGREEN + "Data from table " + table_name + " transformed successfully!\n" + colors.bcolors.ENDC)
...
def transform_cam_data():
    print(colors.bcolors.HEADER + "Transforming CAM data from dsa database..." + colors.bcolors.ENDC)
    cam_data = table_extract("t_data_cam", "cam_key")
    ...
    insert_into_t_clean_cam_table("t_clean_cam", cam_values)

def transform_denm_data():
    print(colors.bcolors.HEADER + "Transforming DENM data from source database..." + colors.bcolors.ENDC)
    denm_data = table_extract("t_data_denm", "denm_key")
    ...
    insert_into_t_clean_denm_table("t_clean_denm", denm_values)

def transform_event_data():
    print(colors.bcolors.HEADER + "Transforming EVENT data from dsa database..." + colors.bcolors.ENDC)
    event_data = table_extract("t_data_event", "event_key")
    ...
    insert_into_clean_table("t_clean_event", event_values)

def transform_ivim_data():
    print(colors.bcolors.HEADER + "Transforming IVIM data from dsa database..." + colors.bcolors.ENDC)
    ivim_data = table_extract("t_data_ivim", "ivim_key")
    ...
    insert_into_t_data_ivim_table("t_clean_ivim", ivim_values)

def transform_road_data():
    print(colors.bcolors.HEADER + "Transforming ROAD data from dsa database..." + colors.bcolors.ENDC)
    road_data = table_extract("t_data_road", "road_key")
    ...
    insert_into_clean_table("t_clean_road", road_values)

def transform_road_event_data():
    print(colors.bcolors.HEADER + "Transforming ROAD EVENT data from dsa database..." + colors.bcolors.ENDC)
    road_event_data = table_extract("t_data_road_event", "road_event_key")
    ...
    insert_into_clean_table("t_clean_road_event", road_event_values)

def transform_road_sign_data():
    print(colors.bcolors.HEADER + "Transforming ROAD SIGN data from dsa database..." + colors.bcolors.ENDC)
    road_sign_data = table_extract("t_data_road_sign", "road_sign_key")
    ...
    insert_into_clean_table("t_clean_road_sign", road_sign_values)

def transform_segment_data():
    print(colors.bcolors.HEADER + "Transforming SEGMENT data from dsa database..." + colors.bcolors.ENDC)
    segment_data = table_extract("t_data_segment", "segment_key")
    ...
    insert_into_t_clean_segment_table("t_clean_segment", segment_values)

def transform_time_data():
    print(colors.bcolors.HEADER + "Transforming TIME data from dsa database..." + colors.bcolors.ENDC)
    time_data = table_extract("t_data_time", "time_key")
    ...
    insert_into_t_clean_time_table("t_clean_time", time_values)

def transform_zone_data():
    print(colors.bcolors.HEADER + "Transforming ZONE data from dsa database..." + colors.bcolors.ENDC)
    ...
    insert_into_clean_table("t_clean_zone", zone_values)

def insert_into_clean_table(table_name, data):
    conn = None
    cursor = None
    ...
    try:
        ...
        print("Error: Could not make a connection to the Postgres database (transform)")
        print(e)
...
def insert_into_t_clean_time_table(table_name, data):
    conn = None
    cursor = None
...
def insert_into_t_clean_segment_table(table_name, data):
    conn = None
    cursor = None
...
def insert_into_t_clean_cam_table(table_name, data):
    conn = None
    cursor = None
...
def insert_into_t_clean_denm_table(table_name, data):
    conn = None
    cursor = None
...
transform_road_sign_data()
transform_event_data()
transform_time_data()
transform_zone_data()
transform_road_data()
transform_segment_data()
transform_cam_data()
transform_denm_data()
transform_ivim_data()