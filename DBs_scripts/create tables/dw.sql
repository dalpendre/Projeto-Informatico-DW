...
(
    ...
    time_key                                                      integer     not null
        references t_dim_time,
    road_event_key                                                integer     not null
        references t_dim_road_event,
...
(
    ...
    road_sign_key integer not null
        references t_dim_road_sign,
    zone_key      integer not null
        references t_dim_zone,
    latitude      integer not null,
    longitude     integer not null,
    altitude      integer not null
);

alter table t_fact_ivim
    owner to postgres;
